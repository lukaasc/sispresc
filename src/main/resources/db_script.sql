...
INSERT INTO INTERNACAO (ID, ID_PRESCRICAO, CPF, DATA_INTERN, LEITO, POSTO, SETOR, MED_RESPONSAVEL, SITUACAO) values (1, 58654, '4561238094583', STR_TO_DATE('15/03/2017', '%d/%m/%Y'), 11, 14, 3, 'betas', 'Internado');
INSERT INTO INTERNACAO (ID, ID_PRESCRICAO, CPF, DATA_INTERN, LEITO, POSTO, SETOR, MED_RESPONSAVEL, SITUACAO) values (2, 86456, '5468741365987', STR_TO_DATE('09/05/2017', '%d/%m/%Y'), 3, 14, 1, 'mmachado', 'Internado');
INSERT INTO INTERNACAO (ID, ID_PRESCRICAO, CPF, DATA_INTERN, LEITO, POSTO, SETOR, MED_RESPONSAVEL, SITUACAO) values (3, 47854, '3698741259654', STR_TO_DATE('01/04/2017', '%d/%m/%Y'), 7, 13, 2, 'betas', 'Internado');
INSERT INTO INTERNACAO (ID, ID_PRESCRICAO, CPF, DATA_INTERN, LEITO, POSTO, SETOR, MED_RESPONSAVEL, SITUACAO) values (4, 69845, '3698547895412', STR_TO_DATE('10/12/2016', '%d/%m/%Y'), 6, 13, 1, 'mmachado', 'Internado');
